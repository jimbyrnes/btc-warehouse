...
- **Snowflake** — eventual warehouse (dbt's target). Config stays isolated;
  no credentials required until the milestone that needs them.
- **dbt** — eventual transformations, tests, documentation, and lineage.
